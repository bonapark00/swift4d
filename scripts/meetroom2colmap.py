...
videos = glob.glob(os.path.join(root_dir, "cam_[0-9]"))
videos = videos + glob.glob(os.path.join(root_dir, "cam_1[0-9]"))
...
print(1,"SIMPLE_PINHOLE", 1280 , 720 ,  focal[0], 1280 , 720 ,  file=object_cameras_file )
